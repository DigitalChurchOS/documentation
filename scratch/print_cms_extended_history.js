...
const data = JSON.parse(fs.readFileSync('C:\\Users\\Administrator\\Documents\\ChurchOS\\scratch\\edit_cms_extended_step_373.json', 'utf8'));
console.log(`Step 373 - Tool: ${data.name}`);
